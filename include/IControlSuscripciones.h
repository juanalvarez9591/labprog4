...
public:
    ...
    virtual void suscribirACliente(vector<string> nickVendedores, string nickCliente) = 0;
    virtual void eliminarSuscripciones(vector<string> nickVendedores, string nickCliente) = 0;
    virtual vector<DTNotificacion> listarNotificaciones(string nickCliente) = 0;
